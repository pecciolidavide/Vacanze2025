...
Indirizzo: [[https://goo.gl/maps/sUsGjAHtu2DnFYQq7][Località Cernaia 695, Grosseto (GR), 58100]]

** Tricount
Link Tricount: https://tricount.com/tCNAyPofhWgzNXaJuI

** Pagamenti alloggio :ignore:noexport:
#+html: <details>
...
#+html: </details>
** Gestione Spese :ignore:noexport:
#+html: <details>
...
**** Pranzo:
- 2 frittate con: zucchine e cipolle, zucchine e pancetta
- Patate
**** Cena:
- Scialatielli allo scoglio
- Anguria (frutta generica)
...
**** Cena:
- Bistecchine impanate (con frutta e verdura(insalata) annessa)
- Peperonata (aka verdure cotte)
...
**** Cena:
- Cena fuori (generica, di pesce)

*** 6 agosto (mercoledì)

**** Pranzo:
- Pasta carbonara
**** Cena: (Ferdy si toglie dalle palle :( )
- Polpette al sugo
...
- Panini (generici)
**** Cena:
- Cena fuori allo scassa palle

*** 8 agosto (venerdì)

**** Pranzo:
- Caprese, straccetti di pollo
**** Cena:
- Pizza in spiaggia
...
** Lista della prima spesa
- Per l'insalata di riso, dobbiamo comprare i contenitori di alluminio (magari delle posate di plastica).
- sgrassatore per cucina
- carta igenica
- panno carta x cucina
- sapone per la lavatrice
- carta stagnola

- Aceto balsamico
- Comprare dell'insalata varia
- sale grosso (forse fino)
- marmellata ai lamponi/ciliegia/amarena
- latte intero (1L)
- succhi di frutta: arancia rossa, ACE, pera
- surgelato misto di pesce per pasta allo scoglio
- farina 00

** Giochi da portare in vacanza :noexport:
...
** Spesa da fare a Torino per i primi giorni :noexport:
